...
var JOLT_PATH = "https://cdn.jsdelivr.net/npm/jolt-physics@0.23.0/dist/jolt-physics.wasm-compat.js";
var frameRate = 60;
var Jolt = null;
...
var LAYER_NON_MOVING = 0;
var LAYER_MOVING = 1;
var NUM_OBJECT_LAYERS = 2;
...
async function JoltPhysics() {
  ...
  function createInstancedBody(mesh, mass, restitution, shape) {
    ...
    for (let i = 0; i < mesh.count; i++) {
      ...
      const quaternion = _quaternion.setFromRotationMatrix(_matrix.fromArray(array, i * 16));
  ...
  function step() {
    ...
    const numSteps = deltaTime > 1 / 55 ? 2 : 1;
...
//# sourceMappingURL=three_addons_physics_JoltPhysics__js.js.map
